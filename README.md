...
1. Open the Gusto folder.
2. Look for a file named README, setup guide, or install file.
3. If you see a Windows app file, double-click it to start.
4. If you see script files, open the instructions in the folder first.
5. Connect the fan controller parts to the PC if the project needs a USB link.
6. Launch the app or control tool.
7. Test the fan speed controls.
8. Check that the IR remote input works.
...
### Fan speed changes but airflow feels weak
